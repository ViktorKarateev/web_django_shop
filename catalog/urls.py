...
from .views import ProductListView, ProductDetailView, ContactsView, ProductUpdateView,ProductDeleteView,ProductCreateView,UnpublishProductView,CategoryProductListView
